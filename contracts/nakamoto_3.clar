...
(define-public (Mint_Nakamoto_1_Android (Nakamoto_1_Level_2-id-1 uint) (Nakamoto_1_Level_2-id-2 uint) (Nakamoto_1_Level_2-id-3 uint))
  (let
    (
      ...
      (nft-1-subtype (default-to u6 (contract-call? .Nakamoto_2 check-subtype Nakamoto_1_Level_2-id-1)))
      (nft-2-subtype (default-to u6 (contract-call? .Nakamoto_2 check-subtype Nakamoto_1_Level_2-id-2)))
      (nft-3-subtype (default-to u6 (contract-call? .Nakamoto_2 check-subtype Nakamoto_1_Level_2-id-3)))
    )
    ...
    (unwrap! (contract-call? .Nakamoto_2 burn Nakamoto_1_Level_2-id-1) ERR-BURN-FIRST)

    ;; Burn Nakamoto_1_Level_2-id-2
    (unwrap! (contract-call? .Nakamoto_2 burn Nakamoto_1_Level_2-id-2) ERR-BURN-SECOND)

    ;; Burn Nakamoto_1_Level_2-id-3
    (unwrap! (contract-call? .Nakamoto_2 burn Nakamoto_1_Level_2-id-3) ERR-BURN-THIRD)
