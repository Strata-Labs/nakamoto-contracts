...
(define-public (Mint_Nakamoto_1_Level_2 (Nakamoto_1_Level_1-id-1 uint) (Nakamoto_1_Level_1-id-2 uint) (Nakamoto_1_Level_1-id-3 uint) (Nakamoto_1_Level_1-id-4 uint))
  (let
    (
      ...
      (nft-1-subtype (default-to u10 (contract-call? .Old_Nakamoto check-subtype Nakamoto_1_Level_1-id-1)))
      (nft-2-subtype (default-to u10 (contract-call? .Old_Nakamoto check-subtype Nakamoto_1_Level_1-id-2)))
      (nft-3-subtype (default-to u10 (contract-call? .Old_Nakamoto check-subtype Nakamoto_1_Level_1-id-3)))
      (nft-4-subtype (default-to u10 (contract-call? .Old_Nakamoto check-subtype Nakamoto_1_Level_1-id-4)))
    )
    ...
    (unwrap! (contract-call? .Old_Nakamoto burn Nakamoto_1_Level_1-id-1) ERR-BURN-FIRST)

    ;; Burn Nakamoto_1_Level_1-id-2 NFT
    (unwrap! (contract-call? .Old_Nakamoto burn Nakamoto_1_Level_1-id-2) ERR-BURN-SECOND)

    ;; Burn Nakamoto_1_Level_1-id-3 NFT
    (unwrap! (contract-call? .Old_Nakamoto burn Nakamoto_1_Level_1-id-3) ERR-BURN-THIRD)

    ;; Burn Nakamoto_1_Level_1-id-4 NFT
    (unwrap! (contract-call? .Old_Nakamoto burn Nakamoto_1_Level_1-id-4) ERR-BURN-FOURTH)
